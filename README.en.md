...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Pixelify+Sans&pause=1000&color=A020F0&width=435&lines=Hi%2C+my+name+is+Samara!" alt="Typing SVG" />
</a>

I am an Analysis and Systems Development (ADS) student at the State University of Paraíba (UEPB), with experience as a Systems Analysis intern at Alcides Carneiro University Hospital (HUAC/UFCG).

I am interested in software development, especially building full-stack web applications, creating and integrating APIs, and developing data-driven systems. I also seek to improve my knowledge of databases, data structures, algorithms, and automation, applying them to create functional, modern, and scalable solutions.
...
| Portfolio                                                         | Data Structures Library                                                     | Art Gallery                                                          |
| :---------------------------------------------------------------- | :-------------------------------------------------------------------------- | :------------------------------------------------------------------- |
| Projects, technical skills, and experience                        | Library with Linked Lists, BST, AVL, B-Tree and other implementations.      | Website for my drawings                                              |
| [View repository](https://github.com/samarasales78/dev-portfolio) | [View repository](https://github.com/samarasales78/data-structures-library) | [View repository](https://github.com/samarasales78/golden-galleryTS) |
