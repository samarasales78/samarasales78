...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Pixelify+Sans&pause=1000&color=A020F0&width=435&lines=%C2%A1Hola%2C+mi+nombre+es+Samara!" alt="Typing SVG" />
</a>

Soy estudiante de Análisis y Desarrollo de Sistemas (ADS) en la Universidad Estatal de Paraíba (UEPB), con experiencia como pasante en el área de Análisis de Sistemas en el Hospital Universitario Alcides Carneiro (HUAC/UFCG).

Me interesa el desarrollo de software, especialmente la construcción de aplicaciones web full stack, la creación e integración de APIs y los sistemas orientados a datos. También busco mejorar mis conocimientos en bases de datos, estructuras de datos, algoritmos y automatización, aplicándolos en la creación de soluciones funcionales, modernas y escalables.
...
| Portafolio                                                        | Biblioteca de Estructuras de Datos                                          | Galería de Arte                                                      |
| :---------------------------------------------------------------- | :-------------------------------------------------------------------------- | :------------------------------------------------------------------- |
| Projects, technical skills, and experience                        | Library with Linked Lists, BST, AVL, B-Tree and other implementations.      | Sitio web para mis dibujos                                           |
| [Ver repositorio](https://github.com/samarasales78/dev-portfolio) | [Ver repositorio](https://github.com/samarasales78/data-structures-library) | [Ver repositorio](https://github.com/samarasales78/golden-galleryTS) |
